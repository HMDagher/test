          ...
          child: Stack(
            children: [
              ...
              Container(
                width: double.infinity,
                height: double.infinity,
                child: custom_widgets.ConfettiWidget(
                  width: double.infinity,
                  height: double.infinity,
                  shouldTrigger: _model.shouldTrigger,
                  particleCount: 50,
                  duration: 3,
                  colors: List.generate(random_data.randomInteger(3, 8),
                      (index) => random_data.randomColor()),
                  confettiStyle: 'explosive',
                  particleShape: 'star',
                  enableMultipleBlasts: true,
                  customGravity: 0.3,
                  customDrag: 0.1,
                ),
              ),
